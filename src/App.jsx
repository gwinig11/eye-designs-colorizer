...
Use the Aspen showroom references ONLY as color and material samples for surfaces already present in the original black-and-white source. The original is the sole authority for objects, geometry, placement, linework, and physical signage. Preserve every original scene detail; only overlaid architectural plan annotations may be removed under the cleanup rules. Do not borrow or substitute the references' furniture, display designs, products, decor, lighting, signs, posters, artwork, logos, or room arrangements. Preserve original signs and branding character by character, including their font, spacing, size, location, and perspective; never redraw, recolor, replace, or change their wording. Apply finishes around signs without painting over the lettering or graphics. Empty areas stay empty. If a reference finish would change an original line or object, simplify the finish instead. Apply a bright white wood-grain palette with black hardware, a pale neutral floor, and gray weathered-wood main walls. The main retail feature walls must clearly read as horizontal wood, with sage and slate used only as restrained secondary accents. Keep the reduced tan/beige cast: white cabinetry must read clean white, the floor light ash-gray, and secondary walls neutral off-white; do not blend them into one cream, sand, or sepia palette.
